...
public class ParcelaMft {
	...
	public String getTxObservacaoParcela() {
		return txObservacaoParcela;
	}

	public void setTxObservacaoParcela(String txObservacaoParcela) {
		this.txObservacaoParcela = txObservacaoParcela;
	}
	...
	public Integer getLgTestemunha() {
		return lgTestemunha;
	}

	public void setLgTestemunha(Integer lgTestemunha) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + (int) (cdParcela ^ (cdParcela >>> 32));
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ParcelaMft other = (ParcelaMft) obj;
		if (cdParcela != other.cdParcela)
			return false;
		return true;
	}
